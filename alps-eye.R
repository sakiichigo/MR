...
#用idp作暴露
workPath="D:/document/bioInfo/alps-eye"
dir.create(workPath)
idpPath="E:/anaFiles/alpsGwas/ALPS/"
idpCsvPath="E:/anaFiles/alpsGwas/csv/"
#导出or,he,ple记录
saveRecord=TRUE
...
if(TRUE){
  ...
  n=thisName
  csvFileName=paste0(idpCsvPath,thisName,".txt")
  expCsvName=paste0("E:/anaFiles/alpsGwas/exp-6/",thisName,".exp.csv")
