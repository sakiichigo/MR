...
dir.create(workPath)
idpPath="E:/hfGwas/HERMES2_GWAS_HF_EUR/tsv/"
idpCsvPath="E:/hfGwas/HERMES2_GWAS_HF_EUR/csv/"
#导出or,he,ple记录
saveRecord=TRUE
...
for(filename in idpLists){
  ...
  expCsvName=paste0("E:/hfGwas/HERMES2_GWAS_HF_EUR/exp/",thisName,".exp.csv")
